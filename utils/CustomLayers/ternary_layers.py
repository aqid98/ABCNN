...
from utils.CustomOperations.ternary_ops import ternarize, ternarize_dot


class Clip(constraints.Constraint):
    ''' Clipping low bitwits gradients
    References:
    ...
    def __call__(self, p):
        # Call the clip function with the set minimum value and maximum value
        return K.clip(p, self.min_value, self.max_value)

    def get_config(self):
        # Update the minimum value and maximum value configuration
        return {"min_value": self.min_value, "max_value": self.max_value}


class TernaryDense(Dense):
    ''' Ternarizing a Keras Dense layer
    References: 
    - [RNN precision](http://arxiv.org/abs/1608.06902)
    - [Ternary Nets](http://arxiv.org/abs/1605.04711)
    '''
...
class TernaryConv2D(Conv2D):
    '''Ternarizing a Keras Convolution2D layer
    References: 
    - [RNN precision](http://arxiv.org/abs/1608.06902)
    - [Ternary Nets](http://arxiv.org/abs/1605.04711)
    '''
